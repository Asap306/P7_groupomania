...
<template>
  <div class="container">
    <div class="row gutters">
      <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" style="margin-top: 1rem">
      ...
      <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12" style="margin-top: 1rem">
        <div class="card h-100">
          <div class="card-body">
            <div class="row gutters">
